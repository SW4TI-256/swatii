...
def checks(oks,cps,twf):
    ...
    if len(cps) != 0:
        ...
        print('\n\n\x1b[1;97m MUMTAZ OK : \x1b[1;97m %s  \x1b[1;97mKB-OK.txt' % (

            H, P, str(len(oks))))

        print('\x1b[1;97m MUMTAZ CP :\x1b[1;97m   %s \x1b[1;97mKB-CP.txt' %

              (H, P, str(len(cps))))

        print('\x1b[1;97m MUMTAZ 2F :\x1b[1;97m   %s \x1b[1;97mKB-2F.txt' %
...
def free(uid,pwx,tl):
    ...
    try:
        ...
        sys.stdout.write(f'\r\33[1;37m[SW4TI] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
